...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/usr/local/python_for_gurobishell/3.11.4/bin',
 'BINLIBDEST': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11',
 ...
 'CC': 'gcc',
 'CCSHARED': '',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -arch x86_64 '
           '-mmacosx-version-min=10.9',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--enable-universalsdk=/' '--with-universal-archs=universal2' "
                "'--prefix=/usr/local/python_for_gurobishell/3.11.4' "
                "'CFLAGS=-mmacosx-version-min=10.9' "
                "'LDFLAGS=-mmacosx-version-min=10.9'",
 'CONFINCLUDEDIR': '/usr/local/python_for_gurobishell/3.11.4/include',
 'CONFINCLUDEPY': '/usr/local/python_for_gurobishell/3.11.4/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/luce/tmp/Python-3.11.4/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/Users/luce/tmp/Python-3.11.4/lcov-report',
 ...
 'DESTDIRS': '/usr/local/python_for_gurobishell/3.11.4 '
             '/usr/local/python_for_gurobishell/3.11.4/lib '
             '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11 '
             '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11/lib-dynload',
 'DESTLIB': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/local/python_for_gurobishell/3.11.4/include '
                   '/usr/local/python_for_gurobishell/3.11.4/include '
                   '/usr/local/python_for_gurobishell/3.11.4/include/python3.11 '
                   '/usr/local/python_for_gurobishell/3.11.4/include/python3.11',
 'INCLUDEDIR': '/usr/local/python_for_gurobishell/3.11.4/include',
 'INCLUDEPY': '/usr/local/python_for_gurobishell/3.11.4/include/python3.11',
 ...
 'LDFLAGS': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'LDFLAGS_NODIST': '',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11',
 'LIBDIR': '/usr/local/python_for_gurobishell/3.11.4/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -DNDEBUG -g -fwrapv -O3 -Wall -arch '
                    'arm64 -arch x86_64 -mmacosx-version-min=10.9 -std=c11 '
 ...
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DUNIVERSAL=1 -DNDEBUG -g '
                    '-fwrapv -O3 -Wall -arch arm64 -arch x86_64 '
                    '-mmacosx-version-min=10.9 -std=c11 '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include',
 'LIBMPDEC_HEADERS': '\\',
 'LIBMPDEC_OBJS': '\\',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/python_for_gurobishell/3.11.4/lib/pkgconfig',
 'LIBPL': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/python_for_gurobishell/3.11.4/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '10.9',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/usr/local/python_for_gurobishell/3.11.4/share/man',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -arch '
                             'x86_64 -mmacosx-version-min=10.9 -std=c11 '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  -I./Include/internal -I. '
                             '-I./Include -DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -arch x86_64 '
              '-mmacosx-version-min=10.9',
 'PY_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -I./Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -arch x86_64 '
                   '-mmacosx-version-min=10.9 -std=c11 '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I./Include/internal -I. -I./Include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-arch arm64 -arch x86_64 -mmacosx-version-min=10.9',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
 'PY_SQLITE_HAVE_SERIALIZE': 1,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -arch '
                        'x86_64 -mmacosx-version-min=10.9 -std=c11 '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/usr/local/python_for_gurobishell/3.11.4/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python.exe -E ./Tools/scripts/run_tests.py',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './usr/local/python_for_gurobishell/3.11.4',
 'WASM_STDLIB': './usr/local/python_for_gurobishell/3.11.4/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Users/luce/tmp/Python-3.11.4',
 'abs_srcdir': '/Users/luce/tmp/Python-3.11.4',
 'datarootdir': '/usr/local/python_for_gurobishell/3.11.4/share',
 'exec_prefix': '/usr/local/python_for_gurobishell/3.11.4',
 'prefix': '/usr/local/python_for_gurobishell/3.11.4',
 'srcdir': '.'}
